...
\begin{figure}
	\centerline{\psfig{figure=figure/FMANU_MD_05_1107_11.eps,width=3.34in}}
...
%%%%%%%%%%%%%%%% begin figure %%%%%%%%%%%%%%%%%%%
\begin{figure}
	\centerline{\psfig{figure=figure/FMANU_MD_05_1272_5.eps,width=3.34in}}
...
\begin{figure}
	...
	\centerline{\psfig{figure=figure/FMANU_MD_04_1274_13.eps,width=3.25in}}
...
\begin{figure*}
	\centerline{\psfig{figure=figure/FMANU_MD_04_1274_13.eps,width=6.85in}}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width = 0.5\textwidth]{figure/all_TW.png}
	\caption{Bifurcation diagram Multi-TW solution for the wide case.}
	\label{fig:bif_multi_tw_solution_wide}
\end{figure}
